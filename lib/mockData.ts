...
export const initialServices: ServiceItem[] = [
  ...
  },
  {
    ...
    name: 'Skin Fade',
    description: 'Close fade blended cleanly into your preferred length.',
    price: 50,
    duration_minutes: 40,
    category: 'Cut',
    image_url: '/service-haircut.jpg',
  ...
  },
  {
    ...
    name: 'Taper Fade',
    description: 'A clean taper around the neckline and sideburns.',
    price: 45,
    duration_minutes: 35,
    category: 'Cut',
    image_url: '/service-haircut.jpg',
  ...
  },
  {
    id: 'service-kids-cut',
    name: 'Kids Cut',
    description: 'A sharp, comfortable cut for younger clients.',
    price: 30,
    duration_minutes: 25,
    category: 'Cut',
    image_url: '/service-haircut.jpg',
  ...
  },
  {
    ...
    name: 'Beard Shape Up',
    description: 'Detailed beard shaping with clean lines and symmetry.',
    price: 30,
    duration_minutes: 25,
    category: 'Grooming',
    image_url: '/service-beard.jpg',
  ...
  {
    id: 'service-premium-combo',
    name: 'Premium Grooming Combo',
    description: 'Haircut, beard detailing, wash, and styling finish.',
    price: 85,
    duration_minutes: 75,
    category: 'Combo',
    image_url: '/service-combo.jpg',
  ...
  },
  {
    ...
    name: 'Hair Coloring',
    description: 'Expert color treatment with a professional finish.',
    price: 85,
    duration_minutes: 90,
    category: 'Color',
    image_url: '/service-haircut.jpg',
  ...
  {
    id: 'service-wash-style',
    name: 'Wash & Style',
    description: 'Cleanse, blow dry, and style for a fresh finish.',
    price: 25,
    duration_minutes: 25,
    category: 'Wellness',
    image_url: '/service-facial.jpg',
  ...
  {
    id: 'service-grey-blending',
    name: 'Grey Blending',
    description: 'Subtle color blending for a natural look.',
    price: 45,
    duration_minutes: 45,
    category: 'Color',
    image_url: '/service-haircut.jpg',
  ...
  },
  {
    ...
    name: 'Highlights',
    description: 'Detailed highlight work for dimension and brightness.',
    price: 75,
    duration_minutes: 75,
    category: 'Color',
    image_url: '/service-haircut.jpg',
  ...
  {
    id: 'service-full-color',
    name: 'Full Color',
    description: 'Complete color service with consultation and finish.',
    price: 95,
    duration_minutes: 90,
    category: 'Color',
    image_url: '/service-haircut.jpg',
